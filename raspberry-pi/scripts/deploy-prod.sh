...
case "$1" in
    ...
    *)
        echo "🍓 Script de déploiement Production eLibrary"
        echo ""
        ...
        echo ""
        echo "Avantages du déploiement Production:"
        echo "  ⚡ Démarrage rapide (2-3 minutes vs 30-60 minutes)"
        echo "  🔄 Auto-update via Watchtower toutes les 5 minutes"
        echo "  📦 Images versionnées et testées"
